    ...
    <form action="{{ route('scholarship.generalinfo', ['id' => $scholarship->id]) }}" method="POST">
      ...
      <section class="border rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            ...
            <input name="client_birthdate" type="text" class="datepicker mt-1 w-full max-w-full border rounded-lg p-2 responsive-text-xs" placeholder="Birthday" required />
          </div>
          <div>
      ...
      <section class="mt-10 border rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            <label class="block font-medium responsive-text-small">Date of Birth</label>
            <input name="beneficiary_birthdate" type="text" class="datepicker mt-1 border rounded-lg p-2 responsive-text-xs w-full max-w-full" placeholder="Birthday" required />
          </div>
        </div>
...
@section('scripts')
  @vite(['resources/js/scholarships/create.js'])
@endsection
