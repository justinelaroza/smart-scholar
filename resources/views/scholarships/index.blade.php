    ...
    <div class="flex flex-col justify-center items-center gap-5 md:gap-8 w-[90%] lg:w-3/4">
      ...
      <form method="GET" action="{{ route('scholarship') }}" class="flex flex-col w-full gap-3 md:gap-5 responsive-text-small">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center w-full gap-1">
          ...
          <select name="education_level" onchange="this.form.submit()" class="w-full md:w-auto px-3 py-2 text-gray-700 border-b border-gray-300 md:border-0">
            <option value="">Sort Education Level</option>
            <option value="Senior High School" {{ request('education_level') == 'Senior High School' ? 'selected' : '' }}>Senior High School</option>
          ...
          <select name="status" onchange="this.form.submit()" class="w-full md:w-auto px-3 py-2 text-gray-700 border-b border-gray-300 md:border-0">
